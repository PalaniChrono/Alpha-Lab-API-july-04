...
class ResponseRepository
{
    ...
    public function cloudinaryImage($file, $folder, $name) {
        ...
        $uploadUrl = Cloudinary::upload($image_path, ['folder' => 'alphalab/'.$folder, 'public_id' => $name])->getSecurePath();
        return $uploadUrl;
    }
    public function cloudinaryImageResume($file, $folder, $name) {
        // $image_path = $file->getRealPath();
        $uploadUrl = Cloudinary::upload($file, ['folder' => 'alphalab/'.$folder, 'public_id' => $name])->getSecurePath();
        return $uploadUrl;
    }
